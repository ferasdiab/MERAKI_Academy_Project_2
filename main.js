...
const comedyMovieRating = [{rating :10 ,userNum:1},{rating :6 ,userNum:50},{rating :7 ,userNum:50}]
...
const rinderComedy = ()=>{
    ...
    for (let i=0; i<comedyMovieName.length;i++){
        ...
        $("#ComedyCH"+i).append(`<h4>Rating : ${Math.round(localStorage.getItem(comedyMovieName[i]))}/10 From ${comedyMovieRating[i].userNum} Rate </h4>`)
